...
新しく clone したメンバーは、まずこの順で進めてください。
...
- リポジトリには `.env`、Instagram クッキー、出力動画は含まれません
- Instagram のログイン情報は各メンバーがローカルで管理してください
- アカウントのメールアドレスやパスワードを README や GitHub に書かないでください
...
- リポジトリには Instagram のログイン情報を含めません。各メンバーが自分のローカル環境でログインしてクッキーを書き出してください
